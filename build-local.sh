...
FLOW=${1:-compile}
case "$FLOW" in
    map) CMD="quartus_map --read_settings_files=on projects/stunrun_pocket.qpf -c stunrun_pocket" ;;
    compile) CMD="quartus_sh --flow compile projects/stunrun_pocket.qpf" ;;
